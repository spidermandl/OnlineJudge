...
<td><a id="defunct-<?php echo($p->problem_id);?>" class="dp btn" data-url="<?php echo e::url("/admin/problem/defunct"); ?>" data-value="<?php echo $p->problem_id;?>"><?php echo(__($p->defunct));?></a></td>
